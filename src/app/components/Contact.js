...
function Contact() {
  ...
  const onSubmit = (formData) => {
    window.location.href = `mailto:victorbamikole92@gmail.com?subject=${formData.subject}&body=${formData.body},${formData.message},(${formData.email})`;
  };
  return (
        ...
        <div className="space-y-5">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-xl text-white text-center">
              victorbamikole92@gmail.com
            </p>
          </div>

          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="h-8 w-8 animate-pulse" />
            <p className="text-xl text-white text-center">Lagos</p>
          </div>
        </div>
